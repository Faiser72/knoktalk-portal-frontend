...
export class DiscoverysectionlistComponent implements OnInit {
  ...
  routeToDeleteDiscoverSection(discorySectionDetails: any) {
    ...
    if (confirm(`Are you sure to delete this discovery section ?`)) {
      console.log(discorySectionDetails.id);
...
export class editDiscovery {
  ...
  constructor(
    ...
    // console.log('rambabus popup cute ram babu',this.editdiscovery);
  ...
  ngOnInit() {
    ...
    //   this.id = data.id;
    //   console.log("The is here", this.id);

    // });
    // console.log("Id is ", this.editdiscovery.id);
    // this.discovetSectionService.getDiscoverSectionDetails()
